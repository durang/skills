...
description: "Guardar en el brain de Sergio. Dispara con: 'guarda en gbrain' y 23 variantes ES/EN; ENTRENAMIENTO ('hoy entrene', 'fui al gym', 'hice pecho', 'me toco pierna', 'hazme una rutina') -> training/sesiones/YYYY-MM-DD y training/rutinas/<slug>, la sesion SIEMPRE enlaza a su rutina; FRICCION Y ESTADO ('esto me frustra', 'me tiene harto', 'estoy emocionado con', 'me confunde') -> reflections/YYYY-MM-DD-<tema>, captura PASIVA: guardar el porque, nunca preguntar como se siente. Extrae entidades, decisiones e ideas originales; slugs con namespace obligatorio; get_page antes de put_page; marca contradicciones sin sobrescribir; cada pagina cierra con ## Related y effective_date; confirma con los slugs reales escritos."
